                    ...
                    <section className="card pb-16 pr-16 flex-auto layout-column justify-content-center">
                        <ul className="pl-0" data-testid="location-list">
                                ...
                                <li key={'row' + index} data-testid={'location-' + index}
                                    ...
                                    <div>
                                        {index !== 0 && <button className="icon-only small mx-0" data-testid="up-button" onClick={() => this.props.onMoveUp(location)}>
                                            <i className="material-icons">arrow_upward</i>
                                        </button>}
                                        {index !== this.props.locations.length-1 && <button className="icon-only small mx-0" data-testid="down-button" onClick={(e) => this.props.onMoveDown(index)}>
